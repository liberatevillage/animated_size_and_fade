...
/// parameters, then [AnimatedHeightAndFade] will **NOT** do a transition between them, since as far as
...
///
class AnimatedHeightAndFade extends StatelessWidget {
    ...
    var animatedSize = AnimatedSize(
      ...
      child: AnimatedSwitcher(
        child: show
            ? child
            : Container(
                key: AnimatedHeightAndFade._key,
